...
import ar.edu.uncuyo.ej2b.service.BaseServiceImpl;
...
public abstract class BaseControllerImpl<E extends Base, S extends BaseServiceImpl<E, Long>>
    ...
    // 🔹 Importante: este método no debe estar mapeado
    public abstract ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody AutorDto autorDto)
            throws Exception;
}
...
//    @PutMapping("/{id}")
//    public abstract ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody AutorDto autorDto) throws Exception;
//}
